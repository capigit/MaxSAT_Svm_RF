...
def evaluer_rf_lad(X_train, X_test, y_train, y_test, liste_mss, K=10, random_state=42):
    ...
    generateur = random.Random(random_state)
    mss_selectionnes = generateur.sample(liste_mss, K) 
